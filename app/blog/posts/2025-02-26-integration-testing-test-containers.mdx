...
First, let's configure a integration tests base class, that will manage the Postgresql Container lifecycle and your test classes will inherit from. Here is an example of how you can write it:
