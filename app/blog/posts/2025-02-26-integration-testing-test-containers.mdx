...
I will take advantage of already prepared PostgreSql container, so that I don't need to configure it myself. First, let's configure a integration tests base class, that your test classes will inherit from and will manage the Postgresql Container lifecycle. Here is an example of how you can write it:
